...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const dateNow = luxon_1.DateTime.utc().setZone(timezone).toFormat('yyyy-MM-dd');
            const body = {
                projectId: projectId,
                name: releaseName,
            ...
            const response = yield (0, node_fetch_1.default)(`https://${serverAddress}/rest/api/latest/version`, {
                method: 'POST',
                headers: {
