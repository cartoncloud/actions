...
module.exports = eval("require")("data-uri-to-buffer");
...
module.exports = eval("require")("web-streams-polyfill/dist/ponyfill.es2018.js");
...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(303))
  }
}
...
// EXTERNAL MODULE: ./node_modules/@vercel/ncc/dist/ncc/@@notfound.js?data-uri-to-buffer
var _notfounddata_uri_to_buffer = __nccwpck_require__(240);
...
async function fetch(url, options_) {
	return new Promise((resolve, reject) => {
		...
		if (parsedURL.protocol === 'data:') {
			const data = _notfounddata_uri_to_buffer(request.url);
...
// EXTERNAL MODULE: ./node_modules/luxon/build/node/luxon.js
var luxon = __nccwpck_require__(811);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const dateNow = luxon/* DateTime.utc */.ou.utc().setZone(timezone).toFormat('yyyy-MM-dd');
            const body = {
                projectId: projectId,
                name: releaseName,
                description: releaseDescription !== null && releaseDescription !== void 0 ? releaseDescription : undefined,
                archived: false,
                released: isReleased,
            ...
            const response = yield fetch(`https://${serverAddress}/rest/api/latest/version`, {
                method: 'POST',
                headers: {
