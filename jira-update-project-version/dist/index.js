...
async function run() {
  try {
    ...
    const today = import_luxon.DateTime.utc().setZone(timezone).toFormat("yyyy-MM-dd");
    const body = {
      projectId,
      id: releaseId,
      name: releaseName ? releaseName : void 0,
      description: releaseDescription ? releaseDescription : void 0,
      archived: false,
      released: isReleased,
      releaseDate: isReleased ? today : void 0
    };
