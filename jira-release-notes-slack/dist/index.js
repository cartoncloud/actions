...
function getSlackUserId({ email, token }) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield (0, node_fetch_1.default)(`https://slack.com/api/users.lookupByEmail?&email=${email}`, {
            method: 'GET',
            headers: {
...
function generate({ title, issuesJson, slackToken }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const email of Object.keys(emailsToUser)) {
            const userId = yield getSlackUserId({ email: email, token: slackToken });
            if (userId) {
